...
public class ReadTestData
{
	 ...
	 * @throws IOException
	 */
	public ReadTestData(final String propertiesFileName) throws IOException
	{
		prop = new Properties();
		prop.load(ReadTestData.class.getClassLoader().getResourceAsStream(propertiesFileName));
