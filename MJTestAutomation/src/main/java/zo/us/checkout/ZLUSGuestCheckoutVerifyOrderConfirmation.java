 ...
 *
 */
public class ZLUSGuestCheckoutVerifyOrderConfirmation
{
	...
	private static final String CUST_PHONE = "6514685841";
	 ...
	 * @throws Exception
	 */
	public void testZLUSGuestCheckoutVerifyOrderConfirmation(final WebDriver driver, final String baseUrl) throws Exception
	{
		//GO TO PDP
