 ...
 *
 */
public class MJB2CCALoginCheckoutVerifyOrderConfirmation
{
	 ...
	 * @throws Exception
	 */
	public void testMJB2CCALoginCheckoutVerifyOrderConfirmation(final WebDriver driver, final String baseUrl) throws Exception
	{
