 ...
 *
 */
public class MJB2CCAGuestCheckoutVerifyOrderConfirmation
{
	 ...
	 * @throws Exception
	 */
	public void testMJB2CCAGuestCheckoutVerifyOrderConfirmation(final WebDriver driver, final String baseUrl) throws Exception
	{
