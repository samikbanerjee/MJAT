 ...
 *
 */
public class MJB2CCAForgotPasswordEmailSend
{
	 ...
	 * @throws Exception
	 */
	public void testMJB2CCAForgotPasswordEmailSend(final WebDriver driver, final String baseUrl) throws Exception
	{
		driver.get(baseUrl + "/");
