 ...
 *
 */
public class MJB2CUSLoginCheckoutVerifyOrderConfirmation
{
	 ...
	 * @throws Exception
	 */
	public void testMJB2CUSLoginCheckoutVerifyOrderConfirmation(final WebDriver driver, final String baseUrl) throws Exception
	{
		//GO TO PDP
